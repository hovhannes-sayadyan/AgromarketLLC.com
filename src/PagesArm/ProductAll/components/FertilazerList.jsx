    ...
    return(
        <div className='FertilazerList'>
            ...
            <div className='FertilazersDiv'>
                ...
                <Fertilazers name={`3S ՓՈՔՐ`} img={'./Assets/FERTILAZERS/3S\ small.png'}/>
                ...
                <Fertilazers name={`Engorde ՓՈՔՐ`} img={'./Assets/FERTILAZERS/engorde-removebg-preview.png'}/>
                ...
                <Fertilazers name={`Enzimatiko 30% ՓՈՔՐ`} img={'./Assets/FERTILAZERS/enzimatiko_30_-removebg-preview.png'}/>
                <Fertilazers name={`F Away Zn`} img={'./Assets/FERTILAZERS/f_away_Zn.png'}/>
                <Fertilazers name={`Mol 75`} img={'./Assets/FERTILAZERS/mol75.jpg'}/>
                <Fertilazers name={`Mol 75 ՓՈՔՐ`} img={'./Assets/FERTILAZERS/mol_75-removebg-preview.png'}/>
